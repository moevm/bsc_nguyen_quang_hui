...
D_in = 54  # kw_length, kw_count, avg_cosine, max_cosine
D_out = 1
H = 450
...
kw_assessment_model.load_state_dict(torch.load("./state_dict_50_"+DATASET+".pt"))
    ...
    def candidate_weighting(self,df={}):
        ...
        for i in range(len(self.phrases)):
            ...
            inp = [
                ...
                df[self.kc_lemmas[i]] if self.kc_lemmas[i] in df else 0.003
            ]+five_points
